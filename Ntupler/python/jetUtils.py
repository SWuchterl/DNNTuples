...
def addCustomJets(process, rParam=1.5, jetAlgo='ak15', minPt=150, runOnMC=True, postfix=""):
    ...
    pfJetsSoftDropMass = add_module(
        jetAlgo + 'PFJetsPuppiSoftDropMass' + postfix,
        ak8PFJetsPuppiSoftDropMass.clone(
            ...
            matched = cms.InputTag(pfJetsSoftDrop),
        )
    )
    ...
    getattr(process, patJets).userData.userFloats.src += [pfJetsSoftDropMass]
